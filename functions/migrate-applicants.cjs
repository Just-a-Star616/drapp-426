 ...
 *
 * Run with: GOOGLE_APPLICATION_CREDENTIALS="" GCLOUD_PROJECT=drapp-426 node migrate-applicants.cjs
 *
 * This uses the default Firebase credentials from your logged-in Firebase CLI
 */

const admin = require('firebase-admin');

// Initialize Firebase Admin (uses FIREBASE_CONFIG environment variable in Cloud Functions environment)
// For local use, ensure you have GOOGLE_APPLICATION_CREDENTIALS set to your service account key
process.env.GCLOUD_PROJECT = 'drapp-426';
process.env.FIREBASE_CONFIG = JSON.stringify({
  projectId: 'drapp-426',
  databaseURL: 'https://drapp-426.firebaseio.com',
});
